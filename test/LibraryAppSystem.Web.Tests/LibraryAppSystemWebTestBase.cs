...
{
    public abstract class LibraryAppSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryAppSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryAppSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryAppSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryAppSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryAppSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryAppSystemDbContext, Task<T>> func)
        {
            T result;
