...
namespace LibraryAppSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LibraryAppSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LibraryAppSystemDbContext context)
        {
            _context = context;
        }
